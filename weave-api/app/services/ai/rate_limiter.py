...
class RateLimiter:
    ...
    def _check_hourly_limit(self, user_id: str, module: Optional[str] = None) -> bool:
        """
    ...
    def _check_daily_limit(self, user_id: str, module: Optional[str] = None) -> bool:
        """
        ...
        try:
            ...
            logger.debug(f"Free user {user_id}: {call_count}/{self.FREE_DAILY_LIMIT} calls today")
    ...
    def get_user_remaining_calls(
        self, user_id: str, user_role: str = "user", user_tier: str = "free"
    ) -> dict:
        """
