...
def test_bedrock_streaming_integration(mock_boto3_client):
    ...
    mock_event1 = {
        "chunk": {"bytes": b'{"type": "message_start", "message": {"usage": {"input_tokens": 10}}}'}
    }
    ...
    mock_event4 = {"chunk": {"bytes": b'{"type": "message_delta", "usage": {"output_tokens": 5}}'}}

    # Mock the streaming response
    mock_client_instance = Mock()
    mock_response = {"body": iter([mock_event1, mock_event2, mock_event3, mock_event4])}
