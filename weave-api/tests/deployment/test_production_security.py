...
class TestSecurityConfiguration:
    ...
    def test_cors_headers_configured(self, production_api_url, http_session):
        ...
        response = http_session.options(
            ...
            headers={"Origin": "https://weave.app", "Access-Control-Request-Method": "GET"},
            timeout=10,
        )
    ...
    def test_rls_policies_enabled_production(self, production_supabase_url):
    ...
    def test_debug_mode_disabled_production(self, production_api_url, http_session):
        ...
        response = http_session.get(
            f"{production_api_url}/api/nonexistent-endpoint-12345", timeout=10
        )
