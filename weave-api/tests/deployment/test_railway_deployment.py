...
class TestCICDPipeline:
    ...
    def test_github_workflow_has_required_steps(self):
        ...
        assert any("checkout" in name for name in step_names), "Workflow missing checkout step"
        assert any("railway" in name for name in step_names), (
            "Workflow missing Railway deployment step"
        )
        assert any("health" in name for name in step_names), "Workflow missing health check step"
