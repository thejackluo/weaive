    ...
    >
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          <View style={styles.bulletList}>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              • <RNText style={{ fontWeight: '600' }}>OpenAI</Text> (GPT-4o, GPT-4o-mini) for daily plans and
              quick insights
            </Text>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              • <RNText style={{ fontWeight: '600' }}>Anthropic</Text> (Claude 3.7 Sonnet, Claude 3.5 Haiku) for
          ...
          <View style={styles.bulletList}>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              • <RNText style={{ fontWeight: '600' }}>Supabase</Text> (database, authentication, file storage)
            </Text>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              • <RNText style={{ fontWeight: '600' }}>Railway</Text> (backend API hosting)
            </Text>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              • <RNText style={{ fontWeight: '600' }}>Expo Push</Text> (iOS push notifications via Apple Push
        ...
        <View style={styles.section}>
          ...
          <View style={styles.bulletList}>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              • <RNText style={{ fontWeight: '600' }}>Encryption at Rest:</Text> AES-256 encryption for database
              storage
            </Text>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              • <RNText style={{ fontWeight: '600' }}>Encryption in Transit:</Text> TLS 1.3 for all API
              communications
            </Text>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              • <RNText style={{ fontWeight: '600' }}>Secure Token Storage:</Text> JWT tokens stored in
              device-encrypted keychain (NEVER plain text)
            </Text>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              • <RNText style={{ fontWeight: '600' }}>Access Controls:</Text> Strict need-to-know basis for team
              members
            </Text>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              • <RNText style={{ fontWeight: '600' }}>Regular Audits:</Text> Security audits and penetration
              testing
            </Text>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              • <RNText style={{ fontWeight: '600' }}>Immutable Logs:</Text> Completion events cannot be edited or
        ...
        >
          ...
          <View style={styles.bulletList}>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              • <RNText style={{ fontWeight: '600' }}>Right to Access:</Text> Request a copy of your personal data
            </Text>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              • <RNText style={{ fontWeight: '600' }}>Right to Rectification:</Text> Correct inaccurate or
              incomplete data
            </Text>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              • <RNText style={{ fontWeight: '600' }}>Right to Erasure:</Text> Delete your account and associated
              data ("right to be forgotten")
            </Text>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              • <RNText style={{ fontWeight: '600' }}>Right to Object:</Text> Object to certain data processing
            </Text>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              • <RNText style={{ fontWeight: '600' }}>Right to Data Portability:</Text> Export your data in
              machine-readable format
            </Text>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              • <RNText style={{ fontWeight: '600' }}>Right to Complain:</Text> Lodge a complaint with your local
          ...
          <View style={styles.bulletList}>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              • <RNText style={{ fontWeight: '600' }}>Right to Know:</Text> Know what personal data we collect and
              how it's used
            </Text>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              • <RNText style={{ fontWeight: '600' }}>Right to Delete:</Text> Request deletion of your personal
              data
            </Text>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              • <RNText style={{ fontWeight: '600' }}>Right to Opt-Out:</Text> Opt-out of data "sales" (we don't
              sell data)
            </Text>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              • <RNText style={{ fontWeight: '600' }}>Right to Non-Discrimination:</Text> No discrimination for
          ...
          <View style={styles.bulletList}>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              1. <RNText style={{ fontWeight: '600' }}>In-App Settings:</Text> Export data or delete account via
              Settings → Privacy
            </Text>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              2. <RNText style={{ fontWeight: '600' }}>Email Request:</Text> Contact privacy@weavelight.com or
              support@weavelight.com
            </Text>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              3. <RNText style={{ fontWeight: '600' }}>Response Time:</Text> We respond within 30 days of verified
              requests
            </Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.bulletList}>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              • <RNText style={{ fontWeight: '600' }}>Active Account:</Text> Data retained as long as your account
              is active
            </Text>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              • <RNText style={{ fontWeight: '600' }}>After Deletion:</Text> Most data deleted within 30 days of
              account closure
            </Text>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              • <RNText style={{ fontWeight: '600' }}>Legal Retention:</Text> Some data retained for
              legal/regulatory purposes (e.g., financial records for tax compliance)
            </Text>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              • <RNText style={{ fontWeight: '600' }}>Immutable Logs:</Text> Completion events retained for
              statistical integrity, but anonymized after 90 days of account deletion
            </Text>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              • <RNText style={{ fontWeight: '600' }}>Backups:</Text> Data may persist in backups for up to 90
        ...
        <View style={styles.section}>
          ...
          <View style={styles.bulletList}>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              • <RNText style={{ fontWeight: '600' }}>Primary Storage:</Text> United States (via Supabase,
              Railway)
            </Text>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              • <RNText style={{ fontWeight: '600' }}>GDPR Safeguards:</Text> Standard Contractual Clauses (SCCs)
              for EU data transfers
            </Text>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              • <RNText style={{ fontWeight: '600' }}>Data Protection:</Text> Same protections apply regardless of
              location
            </Text>
          </View>
          <RNText style={[styles.paragraph, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.bulletList}>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              • <RNText style={{ fontWeight: '600' }}>Device Identifiers:</Text> For analytics and crash reporting
            </Text>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              • <RNText style={{ fontWeight: '600' }}>Push Tokens:</Text> Stored for delivering notifications
            </Text>
            <RNText style={[styles.bullet, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
              • <RNText style={{ fontWeight: '600' }}>Local Storage:</Text> App preferences and cached data stored
              on your device
            </Text>
          </View>
          <RNText style={[styles.paragraph, { fontSize: 16, color: 'rgba(255, 255, 255, 0.7)' }]}>
