...
-- 1. Create ai_provider ENUM type
...
-- 3. Rename token columns to match application code
...
-- 4. Create index on provider for cost analysis queries
CREATE INDEX idx_ai_runs_provider_cost ON ai_runs(provider, created_at, cost_estimate)
...
-- 7. Make provider column NOT NULL after backfill
