...
ALTER TABLE user_profiles
  ...
  ADD COLUMN IF NOT EXISTS core_personality VARCHAR(20) CHECK (core_personality IN ('supportive_direct', 'tough_warm')),
  ADD COLUMN IF NOT EXISTS personality_selected_at TIMESTAMPTZ,
  ADD COLUMN IF NOT EXISTS identity_traits JSONB;
...
CREATE INDEX IF NOT EXISTS idx_user_profiles_personality ON user_profiles(core_personality) WHERE core_personality IS NOT NULL;
